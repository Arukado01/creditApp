...
_Front React (Vite) · Back Flask/SQLAlchemy · PostgreSQL · Celery + Redis · JWT_


## Para revisar el proyecto en productivo seguir este enlace: https://creditapp.3-139-21-107.nip.io/
