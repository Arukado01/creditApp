"""add users and credits tables

Revision ID: e29c1993fb36
Revises: 
Create Date: 2025-07-09 21:12:02.170414
...
def upgrade():
    ...
    sa.Column('commercial', sa.String(length=120), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
